//audio player
    ...
    // FOR DEMO PURPOSES: Make every *other* .edge-to-edge-audio a cuepoint and assign an
    // arbitrary audio timing to each
    var counter = 0;
    $('.edge-to-edge-audio').each(function(k,v) {
        var this_img = $('.edge-to-edge-audio:eq(' + k + ')');
